...
Tråling var gjort på relativ grunn og flat bunn, og fra inspeksjon av ekkograp vurderte vi det dit hen at den store forskjellen på min og maks dyp målt på tråldører antagelig ikke er riktig.
...
```{r telegrammer fra dørsensor, echo=FALSE}
...
```{r sammenligning dørsensorer, echo=FALSE}
